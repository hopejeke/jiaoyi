...
import com.jiaoyi.common.util.CartFingerprintUtil;
...
public class OrderController {
     ...
     */
    @PostMapping
    @PreventDuplicateSubmission(key = "T(com.jiaoyi.common.util.CartFingerprintUtil).generateFingerprint(#request)", expireTime = 2, message = "请勿重复提交相同订单")
